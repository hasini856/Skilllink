...
function SkillsPage() {
  ...
  // ================= QUICK OVERVIEW =================
  const openOverviewVideo = (skill) => {
    const url = `https://www.youtube.com/results?search_query=${encodeURIComponent(
      skill + " explained in 2 minutes"
    )}`;
    ...
    <section className="mx-auto max-w-5xl">
      ...
      <div className="rounded-2xl bg-gradient-to-r from-primary-600 to-blue-600 p-6 text-white shadow-lg">
        ...
        <p className="mt-2 text-sm text-blue-100">
          Learn trending technologies and grow your career
        </p>
      ...
      <div className="mt-8 grid gap-5 md:grid-cols-2">
        {filtered.map((skill, index) => {
          const isCompleted = completed.includes(skill.name);
          ...
          return (
            ...
            >
              ...
              <p className="mt-2 text-sm text-slate-500">
                Learn with quick overview videos, full courses, and curated resources.
              </p>
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                ...
                <button
                  onClick={() => openOverviewVideo(skill.name)}
                ...
                <button
                  onClick={() => openFullCourse(skill.name)}
                ...
                <button
                  onClick={() => markCompleted(skill.name)}
              ...
              <div className="mt-5">
                ...
                <div className="mt-2 space-y-2">
                  {skill.blogs.map((blog, blogIndex) => (
                    <a
                      key={blogIndex}
                      href={blog.link}
                      target="_blank"
